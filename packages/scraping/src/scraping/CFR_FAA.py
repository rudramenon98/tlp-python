        ...
        for j in number_of_titles:
            ...
            while current_year != 1996:
                ...
                if check_availability(
                    ...
                    TITLE = (
                        "CFR-" + str(current_year) + "-title" + str(j) + "-vol" + str(i)
                    )
                    ...
                    pdf_link = get_cfr_path(j, current_year, i, "pdf")
                    print("PDF link:", pdf_link)

                    xml_link = get_cfr_path(j, current_year, i, "xml")
...
def cancel_previous_editions(
    ...
    try:
        ...
        for y in range(1, years_to_check):
            ...
            # check if document exists in documents table
            docInDB = find_document_by_url(mysql_driver, pdf_url_to_check)
...
def run(config: ScriptsConfig, scrapeURLId: int):
    ...
    print("Scraped CFR FAA documents")
